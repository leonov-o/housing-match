...
export const HousingCard = ({image, city, region, address, price, rooms, capacity, tags }) => {
    return (
        <div className="rounded-lg bg-white px-4 py-3 w-[360px] h-[420px] font-inter">
            ...
            <div className="p-1">
                ...
                <div className="mt-3 text-2xl font-medium">{price} <span className="text-lg font-light">₴ / місяць</span></div>
